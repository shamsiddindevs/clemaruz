  ...
  return (
    <div className="mt-40 mb-20 container">
      ...
      <div className="flex items-center flex-wrap text-sm mb-8">
        ...
        <Link to={`/product-category/${category?.link}`} className="text-gray-600 hover:text-blue-600">{category?.title}</Link>
        <span className="mx-2">/</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          {/* Buy Button */}
          <a target='_blank' href='https://t.me/shams_dev' className="bg-blue-600 text-white px-8 py-3 rounded-md hover:bg-blue-700 transition-colors mb-8 inline-block">
            Купить
          </a>
      ...
      <RelatedProducts products = {categories.filter(cate => cate.link === category?.link)?.slice(1,5)} />
      {/* Product Related products */}
    </div>
  );
};
